...
import id.behavio.bank.platform.web.PublicHost;
import id.behavio.bank.platform.web.openapi.OpenApiExporter;
import id.behavio.bank.platform.web.openapi.OpenApiImporter;
 ...
 */
@RestController
@RequestMapping("/api/admin/v1/{product:bank}/simulators/{id}/openapi")
